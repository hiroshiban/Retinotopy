...
<div class="fragment" style="background-image:url({MASTERPATH}hb_brain.png); background-position:right top"><pre class="comment">{DESCRIPTION}</pre></div>

<!-- crossreference -->
<h2><a name="_cross"></a>CROSS-REFERENCE INFORMATION <a href="#_top"><img alt="^" border="0" src="{MASTERPATH}up.png"></a></h2>
<div class="fragment" style="background-image:url({MASTERPATH}hb_brain.png); background-position:right top">
This function calls:
...
<div class="fragment" style="background-image:url({MASTERPATH}hb_brain.png); background-position:right top"><pre>{SOURCECODE}</pre></div>
<!-- END source -->

<hr><address>Generated on {DATE} by <strong><a href="http://www.artefact.tk/software/matlab/m2html/" target="_parent">m2html</a></strong> &copy; 2005 using a BVQX_hbtools customized template</address>
</body>
</html>
