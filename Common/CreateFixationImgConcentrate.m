function fix=CreateFixationImgCircular(fixsize,fixcolor,bgcolor,circlesize,gap,show_flag,save_flag)

% Creates a circular fixation image for a monocular display setting.
% function fiximg=CreateFixationImgCircular(:fixsize,:fixcolor,:bgcolor,:circlesize,:gap,:show_flag,:save_flag)
% (: is optional)
%
...
% Last Update: "2019-02-12 14:52:18 ban"
