````MATLAB
% ************************************************************
% Thi is the stimulus parameter file for retinotopy.
% Please change the parameters below.
% For exp/cont/expf/contf/expd/contd/expi/conti/expdf/contdf/expwindows/contsindows stimuli.
% Programmed by Hiroshi Ban   April 01 2011
% ************************************************************
