...
% Last Update: "2019-05-24 11:38:12 ban"
%
%
%
% [input variables]
  ...
  for rr=1:1:sparam.numRepeats
    for cc=1:1:round((sparam.cycle_duration-sparam.rest_duration)/sparam.flip_duration)
      ...
      for pp=1:1:2 % by default, 2 image sets in one background noise flicker
        ...
        imwrite(Screen('GetImage',winPtr,winRect),fullfile(save_dir,sprintf('retinotopy_%s_cycle_%02d_type_%02d_%02d.png',sparam.mode,rr,cc,pp)),'png');
