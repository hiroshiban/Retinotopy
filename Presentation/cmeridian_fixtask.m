...
% Last Update: "2018-12-14 12:41:58 ban"
%
%
%
% [input variables]
...
for cc=1:1:sparam.numRepeats
  ...
  for ff=1:1:nframe_cycle
    ...
    for nn=1:1:nScr
      ...
      DrawTextureWithCLUT(winPtr,checkertexture{stim_id},CLUT{color_id,compensate_id},[],CenterRect(stimRect,winRect)); % checkerboard
